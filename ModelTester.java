...
public class ModelTester {
    ...
    private static void testFiringWhileBulletActiveDoesNothing() {
        ...
        int bullet1X = model.getPlayerBulletX()[0];
        int bullet1Y = model.getPlayerBulletY()[0];
        ...
        int bullet2X = model.getPlayerBulletX()[0];
        int bullet2Y = model.getPlayerBulletY()[0];
    ...
    private static void testBulletReachingTopIsRemoved() {
        ...
        boolean isActive = model.isAnyPlayerBulletActive();
    ...
    private static void testDestroyingAlienIncreasesScore() {
        ...
        if (hitAlien && newScore > initialScore) {
            System.out
                    .println("PASS: Destroying alien increases score (was " + initialScore + ", now " + newScore + ")");
            passCount++;
        } else {
    ...
    private static void testLosingAllLivesTriggersGameOver() {
        ...
        if (!initialGameOver) {
            ...
            if (model.getLives() <= 0 || gameOverNow) {
                System.out.println("PASS: Losing all lives triggers game over (lives=" + model.getLives()
    ...
    private static void testInitialState() {
        ...
        check("no bullet at start", !model.isAnyPlayerBulletActive());
    ...
    private static void testBulletFiring() {
        GameModel model = new GameModel();
        model.firePlayerBullet();
        check("firing creates a bullet", model.isAnyPlayerBulletActive());
        model.firePlayerBullet(); // fire again while one is in flight
        check("can fire multiple bullets", model.isAnyPlayerBulletActive());
