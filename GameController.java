...
public class GameController implements ActionListener, KeyListener {
    ...
    // Timer interval in milliseconds (dynamic, handled by model)
    ...
    private void init() {
        ...
        // Start the game loop
        gameTimer = new Timer(model.getTimerInterval(), this);
        gameTimer.start();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Update timer interval based on game progress
        gameTimer.setDelay(model.getTimerInterval());
